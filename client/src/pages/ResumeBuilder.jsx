...
const ResumeBuilder = () => {
  ...
  try {
    ...
    if (err.name !== "AbortError") {
      await navigator.clipboard.writeText(resumeUrl);
      alert("Share failed, link copied");
    }
  }
};
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <hr className='absolute top-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-blue-500 border-none transition-all duration-2000' style={{width: `${activeSectionIndex * 100 / (sections.length - 1)}%`}}/>
              ...
              <button onClick={() => {toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-gradient-to-br from-green-400 to-green-200 ring-green-300 text-green-950 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                Save Changes
              </button>
