  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" placeholder='Enter a skill (e.g Javascript, Project Management)' onChange={(e) => setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress} className='flex-1 px-3 py-2 text-sm'/>
