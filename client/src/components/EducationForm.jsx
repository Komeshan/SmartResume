  ...
  return (
    <div className='space-y-6'>
        <div className='flex justify-between items-center'>
            ...
            <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm text-blue-700 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors'>
