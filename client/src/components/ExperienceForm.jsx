import { Briefcase, Plus, Space, Sparkles, Trash2 } from 'lucide-react'
                    ...
                    <div key={index} className='border border-gray-200 rounded-lg p-4 space-y-3'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex justify-between items-center'>
                                ...
                                <button className='flex items-center gap-1 px-2 py-1 text-xs text-purple-700 bg-purple-100 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
