  ...
  return (
    <div className='space-y-6'>
        <div className='flex justify-between items-center'>
            ...
            <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm text-blue-700 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors'>
                    ...
                    <div key={index} className='border border-gray-200 rounded-lg p-4 space-y-3'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex justify-between items-center'>
                                ...
                                <button onClick={() => generateDescription(index)} disabled={generatingIndex === index || !experience.position || !experience.company} className='flex items-center gap-1 px-2 py-1 text-xs text-purple-700 bg-purple-100 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
                            ...
                            <textarea value={experience.description || ''} onChange={(e) => updateExperience(index, 'description', e.target.value)} rows={4} className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='Describe your responsibilities and achievements in this role...' />
                        </div>
                    </div>
                ))}
            </div>
